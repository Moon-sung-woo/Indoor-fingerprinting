...
with tf.variable_scope('LSTM_0_loc'):
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./LSTM_0_loc')
        ...
        with open("full_LSTM_loc_0_best.txt", "w") as f:
    ...
    #학습
        ...
        saver.save(sess, './LSTM_0_loc/LSTM_0_loc_test_result.ckpt')
    #검증
