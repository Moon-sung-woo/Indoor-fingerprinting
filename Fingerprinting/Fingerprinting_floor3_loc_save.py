...
print()
'''
with tf.variable_scope('floor3_loc'):
    # ---------------------------------------------------------------------------------------
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./floor3_loc')
        ...
        with open("full_loc_3_best.txt", "w") as f:
    ...
    # 검증
        ...
        saver.save(sess, './floor3_loc/loc_floor3_test_result.ckpt')