...
print()
'''
with tf.variable_scope('floor4_loc'):
    # ---------------------------------------------------------------------------------------
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./floor4_loc')
        ...
        with open("full_loc_4_best.txt", "w") as f:
    ...
    # 검증
        ...
        saver.save(sess, './floor4_loc/loc_floor4_test_result.ckpt')