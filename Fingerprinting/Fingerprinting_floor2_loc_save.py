...
print()
'''
with tf.variable_scope('floor2_loc'):
    # ---------------------------------------------------------------------------------------
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./floor2_loc')
        ...
        with open("full_loc_2_best.txt", "w") as f:
    ...
    # 검증
        ...
        saver.save(sess, './floor2_loc/loc_floor2_test_result.ckpt')