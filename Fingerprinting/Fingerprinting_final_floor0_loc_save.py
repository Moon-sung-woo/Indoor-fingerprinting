...
floor_batch_size = 1
batch_size = 1000
learning_rate = 0.00858858362431644
output_floor = 1
...
print()
'''
with tf.variable_scope('final_0_loc'):
    # ---------------------------------------------------------------------------------------
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./final_0_loc')
        ...
        with open("final_full_loc_0_best.txt", "w") as f:
    ...
    # 검증
        ...
        saver.save(sess, './final_0_loc/final_loc_floor0_test_result.ckpt')