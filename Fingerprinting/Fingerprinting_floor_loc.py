...
layer1 = tf.contrib.layers.fully_connected(X, int(1.88472595e+03), activation_fn=tf.nn.tanh)
...
layer2 = tf.contrib.layers.fully_connected(drop_1, int(2.36825686e+03), activation_fn=tf.nn.tanh)
...
layer3 = tf.contrib.layers.fully_connected(drop_2, int(2.41870067e+03), activation_fn=tf.nn.tanh)
