...
print()
'''
with tf.variable_scope('final_1_loc'):
    # ---------------------------------------------------------------------------------------
...
with tf.Session() as sess:
    ...
    if load_model:
        print('load model...')
        ckpt = tf.train.get_checkpoint_state('./final_1_loc')
        ...
        with open("final_full_loc_1_best.txt", "w") as f:
    ...
    # 검증
        ...
        saver.save(sess, './final_1_loc/final_loc_floor1_test_result.ckpt')